...
>>>>>>> 3756649a537676c47c8b92e38813283b1f34ab5d
        ...
        for (int runs = 0; runs < NR_RUNS; runs++) {
            ...
            Individual.setStatesArray(statesArray);
               for(int i = 0; i< cargoSpace.getPacking().length; i++)        System.out.println(cargoSpace.getPacking()[i].getBaseCoords()[0]);
...
for(int i = 0; i< bestInd.toCargoSpace().getPacking().length; i++)        System.out.println(bestInd.toCargoSpace().getPacking()[i].getBaseCoords()[0]);
