...
public class Display extends JPanel {
    ...
    */
  	public void rotateYClockwise() {
		...
		if (LOG) System.out.println("Rotate Y (clockwise)");
        x = temp;
  	}
  	//------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    */
  	public void rotateYCounterClockwise() {
		...
		if (LOG) System.out.println("Rotate Y (counter-clockwise)");
        x = temp;
  	}
    ...
    */
	public void rotateZCounterClockwise() {
		...
		if (LOG) System.out.println("Rotate Z (counter-clockwise)");
        x = temp;
	}
    ...
    */
	public void rotateZClockwise() {
		...
		if (LOG) System.out.println("Rotate Z (clockwise from above)");
        x = temp;
	}
    ...
    */
	public void rotateXCounterClockwise() {
		...
		if (LOG) System.out.println("Rotate X (counter-clockwise)");
        x = temp;
	}
    ...
    */
	public void rotateXClockwise() {
		...
		if (LOG) System.out.println("Rotate X (clockwise)");
        x = temp;
	}
